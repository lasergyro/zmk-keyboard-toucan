...
According to the [[references/hut1_5.pdf]], the Generic Desktop usage page (0x01) defines controls for the system, such as sleep, power, and do not disturb.
...
For a reference implementation on adding generic desktop controls to ZMK, see [[references/pr2473.patch]].
